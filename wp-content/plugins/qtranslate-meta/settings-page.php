...
<?php wp_nonce_field('update-options'); ?>
	...
	<table class="form-table">
		...
		<td>
			...
			<em><?php _e('Default:' , 'qtranslate-meta'); ?></em> <code>single_post_title</code>
		</td>
		</tr>
	</table>
		 
	<input type="hidden" name="action" value="update" />
	<input type="hidden" name="page_options" value="qtrans_meta_title_suffix" />
	<input type="hidden" name="page_options" value="qtrans_meta_title_hook" />
